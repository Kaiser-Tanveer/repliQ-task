        ...
        <section className="bg-gray-100 text-gray-800">
            <div className="container flex flex-col justify-center items-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
                <div className="flex items-center justify-center p-6 mt-8 lg:mt-0 h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128">
                    <Zoom>
                        <img src={img} alt="" className="object-contain shadow-lg rounded-md h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128 shadow-gray-700" />
                    </Zoom>
                </div>
                    ...
                    <Zoom>
                        ...
                        <div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
                            <label
                                ...
                                className='text-xl font-semibold bg-gradient-to-r from-sky-500 to-pink-400 py-4 px-6 rounded-md uppercase drop-shadow-lg hover:scale-110 hover:text-gray-100 hover:border hover:border-secondary hover:shadow-secondary-focus duration-500'>
                                Book
                            </label>
                        </div>
                    </Zoom>
